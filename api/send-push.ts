...
const MSGS = [
  ...
  { title:"💀 Despierta {nombre}", body:"{rival} ya tiene sus puntos del día. Tú sigues a cero. Vergüenza." },
  { title:"🔥 Último aviso", body:"Llevas el día entero de vago, {nombre}. Mete aunque sea un hábito, anda." },
  { title:"😤 En serio {nombre}?", body:"Son las 10 de la noche. {rival} lleva apuntando desde las 8. Espabila chaval." },
  { title:"🐌 {nombre}...", body:"Eres el único del grupo sin apuntar hoy. Literalmente el último. ¿Qué haces?" },
  { title:"⚡ Oye {nombre}", body:"Hoy tiene puntos: {rival}. No tiene puntos: tú. Adivina quién está ganando." },
  { title:"🤡 Podium", body:"{nombre} hoy = 0 puntos. {rival} hoy = puntos. La brecha crece. Tú decides." },
  { title:"📵 Aquí Podium", body:"Llevas el día mirando el móvil para todo menos para apuntar tus hábitos. Ironic." },
  ...
  { title:"🎯 Podium te recuerda", body:"Cada día sin apuntar es un día que {rival} se pone por delante. ¿Eso quieres?" },
  { title:"🥊 {nombre} vs {rival}", body:"Marcador actual: {rival} con puntos, {nombre} con excusas. Cambia algo." },
  { title:"💅 {nombre} hoy...", body:"Hoy han apuntado sus hábitos todos tus compañeros. Todos. Menos tú, lógicamente." },
  { title:"🚨 Alerta vago", body:"{nombre} sin puntos hoy. {rival} sumando. La racha se rompe. ¿Le dejas ganar así?" },
  ...
  { title:"😂 Anda {nombre}", body:"Llevas todo el día sin meterlo. ¿Crees que {rival} también está de brazos cruzados?" },
